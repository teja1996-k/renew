...
@Component({
  selector: "app-income-and-others",
  templateUrl: "./income-and-others.component.html",
  styleUrls: ["./income-and-others.component.scss"],
  encapsulation: ViewEncapsulation.None
})
export class IncomeAndOthersComponent implements OnInit {
  constructor(
